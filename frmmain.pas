...
uses
  ...
  globals, json2lv, BGRASpriteAnimation;
...
begin
  ...
  // Sender.Canvas.DrawFocusRect(rct);
...
procedure TformMain.ListView1CustomDrawSubItem(Sender: TCustomListView;
...
procedure TformMain.ListView1DrawItem(Sender: TCustomListView;
